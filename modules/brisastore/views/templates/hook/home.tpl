<section class="brisa-hero" aria-labelledby="brisa-hero-title">
  ...
  <div class="brisa-hero-art">
    <img src="{$urls.child_theme_assets}img/hero.webp" width="1200" height="1100" alt="Colección Brisa: botellas de limpieza en tonos verde salvia, crema y terracota" fetchpriority="high">
...
<section class="brisa-section brisa-categories" aria-labelledby="categories-title">
  ...
  <div class="brisa-category-grid">{foreach $brisa_categories as $category}<a class="brisa-category-card" href="{$category.url|escape:'html':'UTF-8'}"><span class="brisa-category-number">0{$category@iteration}</span><img src="{$urls.child_theme_assets}img/category-{$category@iteration}.webp" alt="Esenciales de {$category.name|escape:'html':'UTF-8'}" width="600" height="640" loading="lazy"><div><h3>{$category.name|escape:'html':'UTF-8'}</h3><span aria-hidden="true">↗</span></div></a>{/foreach}</div>
</section>
<section class="brisa-story">
  <div class="brisa-story-art"><img src="{$urls.child_theme_assets}img/ritual.webp" width="1000" height="1000" alt="Botella Brisa y paños de algodón junto a una rama de olivo" loading="lazy"></div>
